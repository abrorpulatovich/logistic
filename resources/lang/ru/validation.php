...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "name_ar" => "Наименование العربية",
        "name_ko" => "Наименование 한국어",
        "name_en" => "Наименование en",
        "name_ru" => "Наименование ru",
        "slug_uz" => "Вид в url-адресе uz",
        "slug_ar" => "Вид в url-адресе العربية",
        "slug_ko" => "Вид в url-адресе 한국어",
        "slug_en" => "Вид в url-адресе en",
        "slug_ru" => "Вид в url-адресе ru",
        "breadcrumb_bg_image" => "Категория изображения",
        "c_order" => "Порядок",
        'title_uz' => 'Заголовок uz',
        'title_en' => 'Заголовок en',
        'title_ru' => 'Заголовок ru',
        'title_ar' => 'Заголовок العربية',
        'title_ko' => 'Заголовок 한국어',
        'short_desc_uz' => 'Краткое описание uz',
        'short_desc_en' => 'Краткое описание en',
        'short_desc_ru' => 'Краткое описание ru',
        'short_desc_ar' => 'Краткое описание العربية',
        'short_desc_ko' => 'Краткое описание 한국어',
        'desc_uz' => 'Описание uz',
        'desc_en' => 'Описание en',
        'desc_ru' => 'Описание ru',
        'desc_ar' => 'Описание العربية',
        'desc_ko' => 'Описание 한국어',
        'image' => 'Изображение',
