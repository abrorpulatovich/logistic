...
return [
    ...
    */
    ...
    'attributes' => [
        "status" => "Holati",
        "name_uz" => "Nomlanishi uz",
        "name_oz" => "Nomlanishi уз",
        "name_en" => "Nomlanishi en",
        "name_ru" => "Nomlanishi ru",
        "slug_uz" => "Urlda ko'rinishi uz",
        "slug_oz" => "Urlda ko'rinishi уз",
        "slug_en" => "Urlda ko'rinishi en",
        "slug_ru" => "Urlda ko'rinishi ru",
        "breadcrumb_bg_image" => "Kategoriya rasmi",
        "c_order" => "Tartibi",
        'title_uz' => 'Sarlavha uz',
        'title_en' => 'Sarlavha en',
        'title_ru' => 'Sarlavha ru',
        'title_oz' => 'Sarlavha oz',
        'short_desc_uz' => 'Qizqacha mazmuni uz',
        'short_desc_en' => 'Qizqacha mazmuni en',
        'short_desc_ru' => 'Qizqacha mazmuni ru',
        'short_desc_oz' => 'Qizqacha mazmuni oz',
        'desc_uz' => 'Mazmuni uz',
        'desc_en' => 'Mazmuni en',
        'desc_ru' => 'Mazmuni ru',
        'desc_oz' => 'Mazmuni oz',
        'image' => 'Rasm',
        'slug' => "URL manzilida ko'rish",
        'name' => 'Nomlanishi',
        'opinion' => 'Biz haqimizda fikri',
        "new_pwd"               => "Yangi parol",
        "conf_pwd"              => "Parolni tasdiqlash"
    ],
